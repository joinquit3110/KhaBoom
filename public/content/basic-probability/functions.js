...
var StepFunctions = (() => {
  ...
  // content/basic-probability/functions.ts
  ...
  // content/basic-probability/components/coin.ts
  var CoinFlip = class extends Solid {
    constructor() {
      super(...arguments);
    ...
    created() {
      ...
      this.addMesh(() => {
        ...
        this.coin = new THREE.Mesh(geo, Solid.solidMaterial(16616448));
    ...
    flip() {
      return __async(this, null, function* () {
        ...
        yield animate((p) => {
          ...
          this.coin.rotation.z = 0.3 * Math.sin(p * 6 * Math.PI);
          this.scene.draw();
        }, 2e3);
        this.isFlipping = false;
      });
  ...
  function simulation($step) {
    ...
    let points = [];
    $step.model.flip = (n = 1) => __async(this, null, function* () {
      $step.score("flip");
      $coin.flip();
      for (let i = 0; i < n; ++i) {

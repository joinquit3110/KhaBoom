...
var StepFunctions = (() => {
  ...
  function findClosest(p, items) {
    ...
    for (const [i, e] of items.entries()) {
      const q12 = e.project(p);
      const d1 = Point.distance(p, q12);
      if (d1 < d) {
        q = q12;
        d = d1;
        index = i;
  ...
  function lineLineIntersection(l1, l2) {
    ...
    const q12 = l1.p1.x * l1.p2.y - l1.p1.y * l1.p2.x;
    const q22 = l2.p1.x * l2.p2.y - l2.p1.y * l2.p2.x;
    const x = q12 * d2x - d1x * q22;
    const y = q12 * d2y - d1y * q22;
  ...
  var Rectangle = class _Rectangle {
    ...
    project(p) {
      ...
      for (const e of this.edges) {
        const q12 = e.project(p);
        if (!q || Point.distance(p, q12) < Point.distance(p, q)) q = q12;
      }
      return q;
    }
    at(t) {

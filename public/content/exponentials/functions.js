...
var StepFunctions = (() => {
  ...
  // content/exponentials/functions.ts
  var functions_exports = {};
  __export(functions_exports, {
    carbonSolver: () => carbonSolver,
    radioactive1: () => radioactive1,
    radioactiveChart: () => radioactiveChart,
    radioactiveEquation1: () => radioactiveEquation1,
    radioactiveTable1: () => radioactiveTable1
  });
  ...
  // content/exponentials/components/atom.ts
  var RED = 13438566;
  var BLUE = 1016562;
  ...
  function addSpheres(points, color, atom) {
    const material = new THREE.MeshPhongMaterial({ specular: 2236962, color });
  ...
  function radioactive1($step) {
    ...
    $atoms[0].one("click", () => {
      ...
      setTimeout(() => $step.score("decay"), 1e3);
    });
  }
  ...
  function radioactiveEquation1($step) {
    ...
    $system.onNextStep({
      1: (equation) => __async(this, null, function* () {
  ...
  function radioactiveChart($step) {
    ...
    $step.model.watch((state) => {
      ...
      $plot.drawPoints(list(0, 18e3, state.hl).map((p) => new Point(p, fn(p))));
    });
  }
  function carbonSolver($step) {
    ...
    $system.onNextStep({
      ...
      6: (equation) => {
        ...
        equation.addTermAfter("\xD7", "-0.585");
        equation.unwrapTerm("-t");
      },
      7: (equation) => {
        equation.replaceTerm("0.585\xD76000", "3510");
      },
      8: (equation) => {
        equation.deleteTerm("-");
        equation.deleteTerm("-");
    ...
    $system.onBackStep({
      2: (equation) => {
        ...
        equation.addTermAfter("\xD7", "1200");
      ...
      7: (equation) => {
        equation.replaceTerm("3510", "0.585\xD76000");
      },
      8: (equation) => {
        equation.addTermBefore("-", "t");
